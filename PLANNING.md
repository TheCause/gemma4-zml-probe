...
## Etat 31 mai 2026 (P5.2.E.0 PASS — oracle PyTorch attention layer 15 × KV13)
...
**P5.2.E ⏳ en cours** (pilote = layer 15 reader → KV layer 13) :
  ...
  - **E.1 ⏳ next** : ZML QK scores only, à comparer vs `scores_raw` de la fixture E.0 (tolérance 1e-4)
  - **E.mask ⏳ plus tard** : sliding mask **réel** sur cas synthétique S=8 window=3 (E.0 ne couvre que S<window)
Tag courant : `p5.2-e0-pytorch-attention-oracle-pass`.
