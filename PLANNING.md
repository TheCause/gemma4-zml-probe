...
## Etat 31 mai 2026 (P5.2.E.1 PASS — ZML QK scores layer 15 × KV13, marge ~42 000×)
...
**P5.2.E ⏳ en cours** (pilote = layer 15 reader → KV layer 13) :
  ...
  - **E.mask ⏳ next** : sliding mask **réel** sur cas synthétique S=8 window=3 (E.0/E.1 ne couvrent que S<window) ; puis E.softmax + E.context
Tag courant : `p5.2-e1-zml-qk-scores-pass`.
