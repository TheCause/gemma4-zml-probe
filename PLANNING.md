...
**P5.2.E ⏳ en cours** (pilote = layer 15 reader → KV layer 13) :
  ...
  - **E.context ⏳ next** : `probs.dot(value_states,.k)` → context `[1,8,4,256]` (branche V corrigée D.5), 1ère chaîne d'attention ZML complète
Tag courant : `p5.2-esoftmax-zml-pass`.
