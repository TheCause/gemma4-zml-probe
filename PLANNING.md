...
Tag courant : `p5.2-econtext-zml-pass`. **P5.2.E COMPLET.** Reste hors-E : `o_proj`+résiduel, layer 14 full attention (p-RoPE proportional, patch zml.nn.rope requis), vrai sliding au compute (S≥512).
